...
pub struct QuicDomainServer {
    ...
    /// CA and Server certificate lifetime in days (default 365)
    #[dynamic(default = "default_ca_certificate_lifetime_days")]
...
pub struct QuicDomainClient {
    ...
    #[dynamic(default = "default_client_certificate_lifetime_days")]
    pub certificate_lifetime_days: u32,
...
/// Client default ephemeral cert lifetime (updated in session)
fn default_client_certificate_lifetime_days() -> u32 {
    7
}

/// Server and CA default ephemeral cert lifetime
fn default_ca_certificate_lifetime_days() -> u32 {
    365
}
